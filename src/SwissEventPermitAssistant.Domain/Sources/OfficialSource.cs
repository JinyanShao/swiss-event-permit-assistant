    ...
    public static readonly IReadOnlyDictionary<string, OfficialSource> All =
        new Dictionary<string, OfficialSource>
        {
            ["SRC-VDF-ENTRY"] = new(
                ...
                new Uri("https://www.ville-fribourg.ch/organiser-manifestation"),
            ...
            ["SRC-VDF-GT1000"] = new(
                ...
                new DateOnly(2026, 8, 23),
                "High"),
            ["SRC-VDF-DURABILITY"] = new(
                "SRC-VDF-DURABILITY",
                "Ville de Fribourg",
                "Directive relative à l'utilisation de vaisselle réutilisable",
                new Uri("https://www.ville-fribourg.ch/reglements-tarifs/300-13"),
                new DateOnly(2026, 8, 23),
                "High"),
